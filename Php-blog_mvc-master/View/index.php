...
<main>
  <img class="carousel" src="static/img/posts/japan-water.jpg">
  ...
  <div class="container">
    ...
    <?php else : ?>
      ...
      <h1 class="page-title center">Destination Japon</h1>
          ...
          <div class="col l6 m6 s12">
            <div class="card hoverable">
              ...
              <div class="card-content">
                ...
                <p><a href="<?= ROOT_URL ?>blog_post_<?= $oPost->id ?>.html" class="textBlack">Voir l'article en entier</a></p>
              </div>
