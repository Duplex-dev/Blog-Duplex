...
<main>
	<div class="container">
		<h1 class="page-title center">Liste des Articles</h1>
				...
				<div class="col s12 m12 l12">
					...
					<div class="row">
						...
						<div class="col s12 m6 l4">
							...
							<br /><br />
							<a class="btn blue-grey lighten-3 waves-effect waves-light black" href="<?= ROOT_URL ?>blog_post_<?= $oPost->id ?>.html">Lire l'article</a>
						</div>
					</div>
				</div>
			</div>
