					...
					<?php if (!empty($this->oComments)) : ?>
						<?php foreach ($this->oComments as $comment) : ?>
							<tr id="commentaire_<?= $comment->id ?>">
								...
								<td>
									<a id="<?= $comment->id ?>" class="btn-floating btn-small pink lighten-4 waves-effect waves-pink lighten-4 see_comment"><i class="material-icons">done</i></a>
									...
									<a href="#comment_<?= $comment->id ?>" class="btn-floating btn-small blue-grey lighten-3 waves-effect waves-light blue modal-trigger"><i class="material-icons">more_vert</i></a>
